...
im_dst = cv2.warpPerspective(img, h, (ancho*3,alto*3))
cv2.circle(im_dst, tuple(np.int32(pts_dst2[0])), radius=5, color=(255,0,0), thickness=-1)
cv2.circle(im_dst, tuple(np.int32(pts_dst2[1])), radius=5, color=(255,0,0), thickness=-1)
cv2.circle(im_dst, tuple(np.int32(pts_dst2[2])), radius=5, color=(255,0,0), thickness=-1)
cv2.circle(im_dst, tuple(np.int32(pts_dst2[3])), radius=5, color=(255,0,0), thickness=-1)
imshow(im_dst, colorbar=False)
