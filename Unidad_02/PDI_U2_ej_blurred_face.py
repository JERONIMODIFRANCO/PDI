...
cv2.rectangle(img2, (yi,xi), (yi+W,xi+H), (255,255,0), 2)   # Agrego un rectángulo  (https://docs.opencv.org/2.4/modules/core/doc/drawing_functions.html?highlight=rectangle)
